...
rm -rf "${installDirectory}/MVC V2 Swift Module.xctemplate"
rm -rf "${installDirectory}/MVC V2 Swift + UITableView.xctemplate"
...
echo "👉🏻  MVC V2 v1.0 Swift 4.1"
echo "👉🏻  MVC V2 v1.0 Swift 4.1 + UITableView"
echo ""
