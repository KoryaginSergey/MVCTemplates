...
typealias ___VARIABLE_moduleName___ViewControllerType = MVCViewControllerV2<___VARIABLE_moduleName___ModelProtocol, ___VARIABLE_moduleName___ViewProtocol>
...
class ___VARIABLE_moduleName___ViewController: ___VARIABLE_moduleName___ViewControllerType, UITableViewDelegate {
    ...
    convenience init(withView view: ___VARIABLE_moduleName___ViewProtocol, model: ___VARIABLE_moduleName___ModelProtocol, dataSource: ___VARIABLE_moduleName___DataSource) {

        self.init(withView: view, model: model)
    ...
    required init(withView view: ___VARIABLE_moduleName___ViewProtocol!, model: ___VARIABLE_moduleName___ModelProtocol!) {
