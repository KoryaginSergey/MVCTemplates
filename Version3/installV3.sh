...
rm -rf "${installDirectory}/MVC V3 Swift Module.xctemplate"
rm -rf "${installDirectory}/MVC V3 Swift + UITableView.xctemplate"
...
echo "👉🏻  MVC V3 v1.0 Swift 5.2"
echo "👉🏻  MVC V3 v1.0 Swift 5.2 + UITableView"
echo ""
